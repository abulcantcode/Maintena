...
// This class is responsible for dealing with the logic behind the activity_pending page.
// This page will retrieve all jobs associated with the dealer which have a value of true for the 'pending' field.
public class PendingActivity extends AppCompatActivity {
    ...
    private void setUpRecyclerView() {
        ...
        Query query = collectionReference.whereEqualTo("contact", email).whereEqualTo("pending", true);
